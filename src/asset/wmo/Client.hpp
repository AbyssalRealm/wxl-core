// Client contract: the target WMO layout the native loader consumes (chunk tags, canonical order, group header, material/flag layouts).
...
// Client contract: the target WMO layout the native loader consumes. The loader walks chunks
